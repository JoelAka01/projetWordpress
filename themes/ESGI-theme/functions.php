...
{    // main style file with versioning based on file modification time
    wp_enqueue_style('main', get_stylesheet_uri(), array(), filemtime(get_stylesheet_directory() . '/style.css'));    // google fonts - overpass (replacing Inter for font consistency)
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Overpass:wght@300;400;500;600;700&display=swap', array(), null);
