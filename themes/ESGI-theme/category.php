...
$category_name = esgi_translate_category_name($category->name);

// 6 posts per page for category
$args = array(
    'post_type' => 'post',
    'posts_per_page' => 6,
    'paged' => $paged,
    ...
    <div class="container">
        ...
        <div class="blog-content">
            <?php if ($category_posts->have_posts()) : ?>
                ...
                <!-- pagination -->
                <?php 
                $total_pages = $category_posts->max_num_pages;
                if ($total_pages > 1) : 
                ?>
            ...
            <?php else : ?>
                <div class="no-posts">
                    ...
                    <p>Sorry, no posts were found in this category. Please try again later.</p>
                </div>
            <?php endif; ?>
        </div>
