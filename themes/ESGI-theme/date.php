...
if ($month) {
    $archive_title = date_i18n('F Y', mktime(0, 0, 0, $month, 1, $year));
    $archive_description = 'Posts from ' . $archive_title;
} else {
    $archive_title = $year;
    $archive_description = 'Posts from ' . $year;
}

// 6 posts per page for date archive
$args = array(
    'post_type' => 'post',
    'posts_per_page' => 6,
    'paged' => $paged,
...
<main class="blog-page date-archive">
    <div class="container">
        ...
        <div class="blog-content">
            <?php if ($archive_posts->have_posts()) : ?>
                ...
                <!-- pagination -->
                <?php 
                $total_pages = $archive_posts->max_num_pages;
                if ($total_pages > 1) : 
                ?>
            ...
            <?php else : ?>
                <div class="no-posts">
                    ...
                    <p>Sorry, no posts were found for this date range. Please try again later.</p>
                </div>
            <?php endif; ?>
        </div>
